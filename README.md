...
| `完成探索` | 领取奖励：⚔️装备(25%-40%) 📜功法(10%-20%) 📦材料(保底) 🔥双倍(5%) |
| `退出秘境` | 放弃探索(无奖励) |
...
- 🎮 初始化5个主题秘境：剑冢遗迹、灵兽巢穴、丹师洞府、玄冰洞窟、天火秘境
- 💎 三大掉落系统：
  - 材料掉落（100%保底）：玄铁、星辰石、紫金神铁、龙鳞等高级材料
  - 装备掉落（25%-40%爆率）：武器、防具、饰品，高级秘境出极品装备
  - 功法掉落（10%-20%爆率）：攻击、防御、身法、终极功法
